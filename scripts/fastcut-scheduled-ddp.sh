#!/bin/bash
#SBATCH --job-name=fastcut_scheduled_ddp
#SBATCH --output=/home/valeryb/logs/fastcut_scheduled_ddp.out
#SBATCH --error=/home/valeryb/logs/fastcut_scheduled_ddp.err
...
RUN_NAME=vindr_scheduled_ddp_g1_nce5_$(date +%Y%m%d)
